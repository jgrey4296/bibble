...
# If false, manual toctree entry (eg: _docs/autoapi/bibble/index) needs to be added:
...
extlinks = {
    # Add ':issue:' role:
    "issue": ("https://github.com/jgrey4296/bibble/issues/%s", "issue %s"),
}
